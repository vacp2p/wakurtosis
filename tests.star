...
node_builders_test = import_module(system_variables.TEST_NODE_BUILDERS_MODULE)
...
def run(plan, args):
    ...
    node_builders_test.test_add_nwaku_service(plan)
    node_builders_test.test_add_gowaku_service(plan)
